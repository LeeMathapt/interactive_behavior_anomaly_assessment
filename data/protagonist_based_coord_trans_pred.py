...
class ProtagonistBasedCoordTransPred:
    """
    This data model is generated based on prediction.
    ...
    def transform(self):
        ...
        csv_files = sorted(list(Path(self.datadir).glob("*preprocessed7.csv")))
    ...
    def train(self):
        ...
        return TensorDataset(data.transpose(1,3)[:-1], data.transpose(1,3)[1:])
    ...
    def coord_transform_protagonist_marker2nose(self,) -> pd.DataFrame:
        ...
        print(self.joints_num)
        print(self.mice_num)
        print(prog_marker.shape)
        ...
        # set the protagonist's marker as 0
        df.loc[:, col_marker] = 0.0
    ...
    def distance_filter(self):
        ...
        distance = (self.data.pow(2)
                    ...
                    .groupby(level=0)
                    .any())
        df = self.data.where(distance.T, 0.0)
...
if __name__ == "__main__":
    ...
    result = ProtagonistBasedCoordTransPred(data="/media/felan/G-DRIVE/AR-LABO/P45_S6_C1/trajectory",
