"""
CNN-LSTM-based autoencoder learn predictionly. The CNN
kernel length to 3 and stride to 2.
...
class VanillaAEPred(torch.nn.Module):
    """
    B: Batch
    C: Channels
    J: Joints
    ...
    def loss_function(self, *args, **kwargs):
        ...
        pred_loss = F.mse_loss(recon, pred)

        return {
            "loss": pred_loss,
            "reconstruction_loss": pred_loss,
        }
